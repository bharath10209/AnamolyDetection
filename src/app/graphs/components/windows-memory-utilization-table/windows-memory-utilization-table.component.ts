...
@Component({
  selector: "app-windows-memory-utilization-table",
  templateUrl: "./windows-memory-utilization-table.component.html",
  styleUrls: ["./windows-memory-utilization-table.component.scss"]
})
export class WindowsMemoryUtilizationTableComponent implements OnInit {
